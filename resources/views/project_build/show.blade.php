                ...
                <div class="col-12 bg-form card-body-admin p-3">
                    ...
                    <div class=" row ">
                        <div class="col-lg-3 col-12 text-lg-left text-center pt-4">
                            <button data-path="{{ $build->statement }}" class="show_doc font-weight-bold ">Заявление
                            </button>
                        </div>
                        <div class="col-lg-3 col-12 text-lg-left text-center pt-4">
                            <button data-path="{{ $build->apu }}" class="show_doc font-weight-bold ">АПУ/ИТУ</button>
                        </div>
                        <div class="col-lg-3 col-12 text-lg-left text-center pt-4">
                            <button data-path="{{ $build->act }}" class="show_doc font-weight-bold ">Гос.акт</button>
                        </div>
                        <div class="col-lg-3 col-12 text-lg-left text-center pt-4">
                            <button data-path="{{ $build->project }}" class="show_doc font-weight-bold ">Проект</button>
                        </div>
                        <div class="col-lg-4 col-12 text-lg-left text-center pt-4">
                            <button data-path="{{ $build->solution }}" class="show_doc font-weight-bold ">Разрешение на
                                строительство(положительное разрешение
                                гос.экспертизы)
                            </button>
                        </div>
                        <div class="col-lg-4 col-12 text-lg-left text-center pt-4">
                            <button data-path="{{ $build->certificate }}" class="show_doc font-weight-bold ">АКТ оценки
